...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("mode", choices=("baseline", "draft_model"))
...
def main() -> int:
    ...
    tensor_parallel_size = int(
        os.environ.get("QAIC_EAGER_DRAFT_TENSOR_PARALLEL_SIZE", "1")
    )
    ...
    try:
        ...
        result = {
            ...
            "draft_model": args.draft_model if args.mode == "draft_model" else None,
